...
namespace Aviary.Macaw.GH.Procedural
{
    public class CellularBase : GH_Component
    {
        ...
        /// </summary>
        public CellularBase()
          : base("Cellular", "Cellular", "Generate a proceedural cellular system or bitmap" + Environment.NewLine + "Built on Auburns' FastNoise" + Environment.NewLine+"https://github.com/Auburns/FastNoise", "Aviary 1", "Image")
        {
        }
