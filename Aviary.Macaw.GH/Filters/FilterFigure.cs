...
namespace Aviary.Macaw.GH.Filters
{
    public class FilterFigure : GH_Component
    {
        ...
        /// </summary>
        public FilterFigure()
          : base("Filter Figures", "Figures", "Identify or modify figure based filters to an image" + Environment.NewLine + "Note: Not all filter modes use the additional parameter inputs." + Environment.NewLine + "Built on the Accord Imaging Library" + Environment.NewLine + "http://accord-framework.net/", "Aviary 1", "Image")
        {
        }

        string message = FilterModes.Closing.ToString();
