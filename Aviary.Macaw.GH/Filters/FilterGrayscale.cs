...
namespace Aviary.Macaw.GH.Filters
{
    public class FilterGrayscale : GH_Component
    {
        ...
        public FilterGrayscale()
          : base("Filter Grayscale", "Grayscale", "Apply grayscale filters to an image" + Environment.NewLine + "Note: Not all filter modes use the additional parameter inputs." + Environment.NewLine + "Built on the Accord Imaging Library" + Environment.NewLine + "http://accord-framework.net/", "Aviary 1", "Image")
        {
        }

        string message = FilterModes.Y.ToString();
